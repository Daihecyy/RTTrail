    ...
    def get_config_dict(self, settings: Settings):
        ...
        return {
            ...
            "loggers": {
                ...
                # rttrail.error should be used to log all errors which does not correspond to one of the specific loggers
                # Other loggers can process error messages and may be more appropriated than rttrail.error
                "rttrail.error": {
                    "handlers": [
                        "file_errors",
                        "matrix_errors",
